    ...
    "https://openrouter.ai/api/v1/chat/completions",
    {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are an expert in PIC18 microcontroller assembly language. Your task is to generate a JSON object for a given instruction, following the provided schema and style.
